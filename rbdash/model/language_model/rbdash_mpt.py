...
class RBDashMPTConfig(MPTConfig):
    model_type = "rbdash_mpt"


class RBDashMPTModel(RBDashMetaModel, MPTModel):
    config_class = RBDashMPTConfig

    def __init__(self, config: MPTConfig):
        config.hidden_size = config.d_model
        super(RBDashMPTModel, self).__init__(config)
    
    def embed_tokens(self, x):
        return self.wte(x)


class RBDashMPTForCausalLM(MPTForCausalLM, RBDashMetaForCausalLM):
    config_class = RBDashMPTConfig
    ...
    def __init__(self, config):
        ...
        self.transformer = RBDashMPTModel(config)
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, RBDashMPTModel):
    ...
    def forward(self, input_ids: torch.LongTensor, past_key_values: Optional[List[Tuple[torch.FloatTensor]]]=None, attention_mask: Optional[torch.ByteTensor]=None, prefix_mask: Optional[torch.ByteTensor]=None, sequence_id: Optional[torch.LongTensor]=None, labels: Optional[torch.LongTensor]=None, return_dict: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, use_cache: Optional[bool]=None, images=None):
        ...
        # FIXME: this is a hack to fix the multiple gpu inference issue in https://github.com/haotian-liu/RBDash/issues/338
...
AutoConfig.register("rbdash_mpt", RBDashMPTConfig)
AutoModelForCausalLM.register(RBDashMPTConfig, RBDashMPTForCausalLM)
